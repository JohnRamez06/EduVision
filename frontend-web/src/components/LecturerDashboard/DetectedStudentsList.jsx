          ...
          students.map((student) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span
                  className={`inline-block mt-1 px-1.5 py-0.5 rounded text-xs capitalize ${EMOTION_STYLE[student.emotion] ?? "bg-slate-500/15 text-slate-300"}`}
                >
                  {student.emotion}
                </span>
              </div>
              <span
                className={`text-xs px-2 py-1 rounded-full capitalize shrink-0 ${CONCENTRATION_STYLE[student.concentration] ?? "bg-slate-500/20 text-slate-300"}`}
              >
