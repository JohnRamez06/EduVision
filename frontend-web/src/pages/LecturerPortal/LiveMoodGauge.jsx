  ...
  return (
    <div className="glass rounded-2xl p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${emoMeta.bg}`}>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="rounded-xl bg-slate-800/60 p-3">
          ...
          <p className="text-xl font-bold text-emerald-400 tabular-nums">{engagement}%</p>
        </div>
        <div className="rounded-xl bg-slate-800/60 p-3">
          <div className="flex items-center gap-1.5 text-xs text-slate-500 mb-1">
      ...
      <div className="flex justify-center mb-3">
        <div className="relative w-28 h-28">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-2xl font-bold text-white tabular-nums">{engagement}%</span>
          </div>
        </div>
      </div>
