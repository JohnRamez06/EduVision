      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {courses.map(c => {
            ...
            return (
              <div key={c.courseId} className="glass rounded-2xl p-5 flex flex-col gap-4 hover:border-[#667D9D]/30 transition-colors group cursor-pointer">
                {/* Header */}
                <div className="flex items-start justify-between gap-3">
                  <div className="w-11 h-11 rounded-xl bg-[#667D9D]/15 flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center justify-between pt-1 border-t border-slate-800/60">
                  ...
                  <ChevronRight size={14} className="text-slate-600 group-hover:text-[#667D9D] transition-colors" />
                </div>
              </div>
            )
          })}
